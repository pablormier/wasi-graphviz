...
### Changed
- Updated the bundled Graphviz build target to 15.0.0.
...
[0.1.1]: https://github.com/pablormier/wasi-graphviz/releases/tag/v0.1.1
[0.1.2]: https://github.com/pablormier/wasi-graphviz/releases/tag/v0.1.2
