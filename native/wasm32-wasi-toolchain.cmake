...
set(CMAKE_C_FLAGS "-D_WASI_EMULATED_SIGNAL -D_WASI_EMULATED_PROCESS_CLOCKS -include ${CMAKE_CURRENT_LIST_DIR}/wasi_stubs.h -include unistd.h ${CMAKE_C_FLAGS}" CACHE STRING "" FORCE)
set(CMAKE_CXX_FLAGS "-D_WASI_EMULATED_SIGNAL -D_WASI_EMULATED_PROCESS_CLOCKS -include ${CMAKE_CURRENT_LIST_DIR}/wasi_stubs.h -include unistd.h ${CMAKE_CXX_FLAGS}" CACHE STRING "" FORCE)
